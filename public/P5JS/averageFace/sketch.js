...
function draw() {
    ...
    text("Left: the sample image chosen at random from 30 sample images.", width/2, height - 70);
    text("Right: the left image blended with other 29 sampple images, at a rate directly correlated to mouse x pos.", width/2, height - 45);
    text("Press any key to randomly select a new sample image.", width/2, height - 20);
    pop();
