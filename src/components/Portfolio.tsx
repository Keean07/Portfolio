...
const projects = [
  { title: 'Local Community Website', image: 'images/braaimasters.png', page: 'LocalCommunityWebsite.html' },
  { title: 'P5.JS Programming Assignments', image: 'images/sinewave.png', page: 'p5Assignments.html' },
  { title: 'Drawing App', image: 'images/drawingApp.png', page: 'drawingApp.html' },
  { title: 'Digit Classification with TensorFlow', image: 'images/DigitClassification.png', page: 'DigitClassification.html' },
  { title: 'CoinHop Game', image: 'images/Coinhop.png', page: 'coinhop.html' },
  { title: 'CyberSpider Game', image: 'images/CyberSpider.png', page: 'CyberSpider.html' },
];
          ...
          {[0, 2, 4].map((startIndex) => (
            <div key={startIndex} className="col-4 col-12-mobile">
              {projects.slice(startIndex, startIndex + 2).map((project) => (
                <article key={project.page} className="item">
                  <a href={asset(project.page)} className="image fit">
